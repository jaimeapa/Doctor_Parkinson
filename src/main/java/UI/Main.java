...
public class Main {
                ...
                while (true) {
                    switch (printLogInMenu()) {
                        case 1: {
                            ...
                            registerDoctor(sendDataViaNetwork, receiveDataViaNetwork, socket);
                            break;
                        }
                        case 2: {
                            sendDataViaNetwork.sendInt(2);
            ...
            if (password != null) {
                ...
                if (message.equals("OK")) {
                    ...
                    if (doctor != null) {
                        ...
                        clientDoctorMenu(sendDataViaNetwork, receiveDataViaNetwork, socket);
                    }
    ...
    public static void registerDoctor(SendDataViaNetwork sendDataViaNetwork, ReceiveDataViaNetwork receiveDataViaNetwork, Socket socket)
    {
        try {
            Doctor doctor;
            User u;
    ...
    public static void clientDoctorMenu(SendDataViaNetwork sendDataViaNetwork, ReceiveDataViaNetwork receiveDataViaNetwork, Socket socket){
        try {
            boolean menu = true;
            while (menu) {
                switch (printDoctorMenu()) {
                    case 1: {
                        sendDataViaNetwork.sendInt(1);
                        viewDetailsOfPatient(sendDataViaNetwork, receiveDataViaNetwork, socket);
                        break;
                    }
                    case 2: {
                        sendDataViaNetwork.sendInt(2);
                        makeAnInterpretation(sendDataViaNetwork, receiveDataViaNetwork, socket);
                        break;
                    }
                    case 3: {
                        menu = false;
    ...
    private static void viewDetailsOfPatient(SendDataViaNetwork sendDataViaNetwork, ReceiveDataViaNetwork receiveDataViaNetwork, Socket socket){
        try {
            Patient patient;
    ...
    private static void makeAnInterpretation(SendDataViaNetwork sendDataViaNetwork, ReceiveDataViaNetwork receiveDataViaNetwork, Socket socket){
        try {
